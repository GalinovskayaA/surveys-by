...
<template>
  <PageComponent>
    ...
    <div v-if="!surveys.loading" class="flex justify-center mt-5">
      <nav
      ...
      >
        <a
          ...
          aria-current="page"
          class="relative inline-flex items-center px-4 py-2 border text-sm font-semibold whitespace-wrap rounded-none focus:outline-none"
